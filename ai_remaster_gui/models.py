...
STAGES = (
    ...
    Stage(
        ...
        (
            ...
            ("edge_left", "Left (− trim / + extend)", "range:-960|960|1", "0"),
            ("edge_right", "Right (− trim / + extend)", "range:-960|960|1", "0"),
            ("edge_top", "Top (− trim / + extend)", "range:-960|960|1", "0"),
            ("edge_bottom", "Bottom (− trim / + extend)", "range:-960|960|1", "0"),
        ),
        (),
    ),
    Stage(
